...
class BeatSheetScreen extends StatelessWidget {
  ...
  static const _saveTheCat = [
    (
      1,
      'Opening Image',
      'A snapshot of the hero\'s problem world before the change.'
    ),
    (
      2,
      'Theme Stated',
      'The thematic premise is stated (often by someone other than the hero).'
    ),
    (
      3,
      'Set-Up',
      'Introduce all the characters. Show the hero\'s flaws and desires.'
    ),
    ...
    (
      6,
      'Break into Two',
      'The hero enters the upside-down world — Act II begins.'
    ),
    (
      7,
      'B Story',
      'The love story / mentor relationship begins. Carries the theme.'
    ),
    (
      8,
      'Fun and Games',
      'The "promise of the premise" — why we bought the ticket.'
    ),
    (9, 'Midpoint', 'A false victory or false defeat. Stakes are raised.'),
    (
      10,
      'Bad Guys Close In',
      'Internal doubts, external enemies all close in.'
    ),
    (11, 'All Is Lost', 'The worst thing possible. The whiff of death.'),
    (
      12,
      'Dark Night of the Soul',
      'The hero has nowhere to turn and digs deep.'
    ),
    (
      13,
      'Break into Three',
      'The solution found — hero decides to fight back.'
    ),
    (14, 'Finale', 'Storm the castle. Execute the plan. Change the world.'),
    (
      15,
      'Final Image',
      'The mirror of the Opening Image. Shows how much has changed.'
    ),
  ];
  ...
  static const _heroJourney = [
    ...
    (
      4,
      'Meeting the Mentor',
      'The hero encounters someone who gives wisdom or tools.'
    ),
    (
      5,
      'Crossing the Threshold',
      'The hero commits and enters the special world.'
    ),
    (
      6,
      'Tests, Allies, Enemies',
      'The hero faces challenges and makes friends/foes.'
    ),
    (
      7,
      'Approach to Inmost Cave',
      'The hero nears the dangerous place of the ordeal.'
    ),
    (8, 'Ordeal', 'The hero faces their greatest fear. Death and rebirth.'),
    (
      9,
      'Reward (Seizing the Sword)',
      'The hero takes possession of the treasure.'
    ),
    ...
    (
      ...
      'The hero returns changed, with something to benefit the world.'
    ),
  ];
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: const TabBar(
              tabs: [Tab(text: 'Save the Cat'), Tab(text: 'Hero\'s Journey')]),
        ),
