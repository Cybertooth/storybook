...
extension StoryPatterns on Story {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String title, String summary, String theme,
            String coreQuestion, DateTime createdAt, DateTime updatedAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Story() when $default != null:
        return $default(_that.id, _that.title, _that.summary, _that.theme,
            _that.coreQuestion, _that.createdAt, _that.updatedAt);
      case _:
        return orElse();
    }
  }
