...
mixin _$Chapter {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, storyId, title, content, order, status);

  @override
  String toString() {
    return 'Chapter(id: $id, storyId: $storyId, title: $title, content: $content, order: $order, status: $status)';
  }
}
...
extension ChapterPatterns on Chapter {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Chapter() when $default != null:
        return $default(_that.id, _that.storyId, _that.title, _that.content,
            _that.order, _that.status);
      case _:
        return orElse();
    }
  }
