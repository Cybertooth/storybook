...
extension RelationshipPatterns on Relationship {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String storyId, String sourceId,
            String targetId, String type, String description)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Relationship() when $default != null:
        return $default(_that.id, _that.storyId, _that.sourceId, _that.targetId,
            _that.type, _that.description);
      case _:
        return orElse();
    }
  }
