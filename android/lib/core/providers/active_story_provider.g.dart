...
final storyListProvider =
    AutoDisposeAsyncNotifierProvider<StoryList, List<Story>>.internal(
  StoryList.new,
...
typedef _$StoryList = AutoDisposeAsyncNotifier<List<Story>>;
...
final activeStoryProvider =
    AutoDisposeNotifierProvider<ActiveStory, Story?>.internal(
  ActiveStory.new,
...
typedef _$ActiveStory = AutoDisposeNotifier<Story?>;
