...
// in storybook_android/test/data/local/export_service_test.dart.
...
import 'package:storybook_android/data/local/database.dart' as _i2;
...
class _Fake$StoriesTableTable_1 extends _i1.SmartFake
    implements _i2.$StoriesTableTable {
  _Fake$StoriesTableTable_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$CharactersTableTable_2 extends _i1.SmartFake
    implements _i2.$CharactersTableTable {
  _Fake$CharactersTableTable_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$LocationsTableTable_3 extends _i1.SmartFake
    implements _i2.$LocationsTableTable {
  _Fake$LocationsTableTable_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$PlotEventsTableTable_4 extends _i1.SmartFake
    implements _i2.$PlotEventsTableTable {
  _Fake$PlotEventsTableTable_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$ChaptersTableTable_5 extends _i1.SmartFake
    implements _i2.$ChaptersTableTable {
  _Fake$ChaptersTableTable_5(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$NotesTableTable_6 extends _i1.SmartFake
    implements _i2.$NotesTableTable {
  _Fake$NotesTableTable_6(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$QuestionsTableTable_7 extends _i1.SmartFake
    implements _i2.$QuestionsTableTable {
  _Fake$QuestionsTableTable_7(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$RelationshipsTableTable_8 extends _i1.SmartFake
    implements _i2.$RelationshipsTableTable {
  _Fake$RelationshipsTableTable_8(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeQueryExecutor_14 extends _i1.SmartFake implements _i3.QueryExecutor {
...
class _FakeFuture_18<T> extends _i1.SmartFake implements _i5.Future<T> {
  _FakeFuture_18(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockAppDatabase extends _i1.Mock implements _i2.AppDatabase {
  ...
  @override
  _i2.$StoriesTableTable get storiesTable => (super.noSuchMethod(
        Invocation.getter(#storiesTable),
        returnValue: _Fake$StoriesTableTable_1(
          this,
          Invocation.getter(#storiesTable),
        ),
      ) as _i2.$StoriesTableTable);

  @override
  _i2.$CharactersTableTable get charactersTable => (super.noSuchMethod(
        Invocation.getter(#charactersTable),
        returnValue: _Fake$CharactersTableTable_2(
          this,
          Invocation.getter(#charactersTable),
        ),
      ) as _i2.$CharactersTableTable);

  @override
  _i2.$LocationsTableTable get locationsTable => (super.noSuchMethod(
        Invocation.getter(#locationsTable),
        returnValue: _Fake$LocationsTableTable_3(
          this,
          Invocation.getter(#locationsTable),
        ),
      ) as _i2.$LocationsTableTable);

  @override
  _i2.$PlotEventsTableTable get plotEventsTable => (super.noSuchMethod(
        Invocation.getter(#plotEventsTable),
        returnValue: _Fake$PlotEventsTableTable_4(
          this,
          Invocation.getter(#plotEventsTable),
        ),
      ) as _i2.$PlotEventsTableTable);

  @override
  _i2.$ChaptersTableTable get chaptersTable => (super.noSuchMethod(
        Invocation.getter(#chaptersTable),
        returnValue: _Fake$ChaptersTableTable_5(
          this,
          Invocation.getter(#chaptersTable),
        ),
      ) as _i2.$ChaptersTableTable);

  @override
  _i2.$NotesTableTable get notesTable => (super.noSuchMethod(
        Invocation.getter(#notesTable),
        returnValue: _Fake$NotesTableTable_6(
          this,
          Invocation.getter(#notesTable),
        ),
      ) as _i2.$NotesTableTable);

  @override
  _i2.$QuestionsTableTable get questionsTable => (super.noSuchMethod(
        Invocation.getter(#questionsTable),
        returnValue: _Fake$QuestionsTableTable_7(
          this,
          Invocation.getter(#questionsTable),
        ),
      ) as _i2.$QuestionsTableTable);

  @override
  _i2.$RelationshipsTableTable get relationshipsTable => (super.noSuchMethod(
        Invocation.getter(#relationshipsTable),
        returnValue: _Fake$RelationshipsTableTable_8(
          this,
          Invocation.getter(#relationshipsTable),
        ),
      ) as _i2.$RelationshipsTableTable);
