...
import 'package:storybook_android/data/local/database.dart' as _i3;
...
class _Fake$StoriesTableTable_2 extends _i1.SmartFake
    implements _i3.$StoriesTableTable {
  _Fake$StoriesTableTable_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$CharactersTableTable_3 extends _i1.SmartFake
    implements _i3.$CharactersTableTable {
  _Fake$CharactersTableTable_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$LocationsTableTable_4 extends _i1.SmartFake
    implements _i3.$LocationsTableTable {
  _Fake$LocationsTableTable_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$PlotEventsTableTable_5 extends _i1.SmartFake
    implements _i3.$PlotEventsTableTable {
  _Fake$PlotEventsTableTable_5(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$ChaptersTableTable_6 extends _i1.SmartFake
    implements _i3.$ChaptersTableTable {
  _Fake$ChaptersTableTable_6(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$NotesTableTable_7 extends _i1.SmartFake
    implements _i3.$NotesTableTable {
  _Fake$NotesTableTable_7(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$QuestionsTableTable_8 extends _i1.SmartFake
    implements _i3.$QuestionsTableTable {
  _Fake$QuestionsTableTable_8(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$RelationshipsTableTable_9 extends _i1.SmartFake
    implements _i3.$RelationshipsTableTable {
  _Fake$RelationshipsTableTable_9(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockAppDatabase extends _i1.Mock implements _i3.AppDatabase {
  ...
  @override
  _i3.$StoriesTableTable get storiesTable => (super.noSuchMethod(
        Invocation.getter(#storiesTable),
        returnValue: _Fake$StoriesTableTable_2(
          this,
          Invocation.getter(#storiesTable),
        ),
      ) as _i3.$StoriesTableTable);

  @override
  _i3.$CharactersTableTable get charactersTable => (super.noSuchMethod(
        Invocation.getter(#charactersTable),
        returnValue: _Fake$CharactersTableTable_3(
          this,
          Invocation.getter(#charactersTable),
        ),
      ) as _i3.$CharactersTableTable);

  @override
  _i3.$LocationsTableTable get locationsTable => (super.noSuchMethod(
        Invocation.getter(#locationsTable),
        returnValue: _Fake$LocationsTableTable_4(
          this,
          Invocation.getter(#locationsTable),
        ),
      ) as _i3.$LocationsTableTable);

  @override
  _i3.$PlotEventsTableTable get plotEventsTable => (super.noSuchMethod(
        Invocation.getter(#plotEventsTable),
        returnValue: _Fake$PlotEventsTableTable_5(
          this,
          Invocation.getter(#plotEventsTable),
        ),
      ) as _i3.$PlotEventsTableTable);

  @override
  _i3.$ChaptersTableTable get chaptersTable => (super.noSuchMethod(
        Invocation.getter(#chaptersTable),
        returnValue: _Fake$ChaptersTableTable_6(
          this,
          Invocation.getter(#chaptersTable),
        ),
      ) as _i3.$ChaptersTableTable);

  @override
  _i3.$NotesTableTable get notesTable => (super.noSuchMethod(
        Invocation.getter(#notesTable),
        returnValue: _Fake$NotesTableTable_7(
          this,
          Invocation.getter(#notesTable),
        ),
      ) as _i3.$NotesTableTable);

  @override
  _i3.$QuestionsTableTable get questionsTable => (super.noSuchMethod(
        Invocation.getter(#questionsTable),
        returnValue: _Fake$QuestionsTableTable_8(
          this,
          Invocation.getter(#questionsTable),
        ),
      ) as _i3.$QuestionsTableTable);

  @override
  _i3.$RelationshipsTableTable get relationshipsTable => (super.noSuchMethod(
        Invocation.getter(#relationshipsTable),
        returnValue: _Fake$RelationshipsTableTable_9(
          this,
          Invocation.getter(#relationshipsTable),
        ),
      ) as _i3.$RelationshipsTableTable);
