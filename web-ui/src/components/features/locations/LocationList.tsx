    ...
    return (
        <div className="space-y-8">
            <div className="flex justify-between items-center">
                <h2 className="text-2xl font-serif font-bold text-stone-800 dark:text-stone-200">World & Locations</h2>
                <button
            ...
            {locations.length === 0 && !isCreating && (
                <div className="text-center py-16 text-stone-400 bg-stone-50/50 dark:bg-stone-800/20 rounded-xl border-2 border-dashed border-stone-200 dark:border-stone-700">
                    <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
                        <Plus className="w-6 h-6 text-emerald-300 dark:text-emerald-600" />
                    </div>
                    <p className="font-medium text-stone-500 dark:text-stone-400">No locations mapped yet</p>
